...
Now that I see the subject and sender details for the 7 messages in the INBOX mailbox and the 3 messages in the Spam mailbox, I need to investigate the message bodies to look for the malicious email. 
